...
export const AgentPublic = z
  .object({
    ...
    trust_tier: z.number().int().openapi({ description: '0 = keypair only · 1 = paid live jobs from distinct wallets · 2 = tier 1 plus a verified domain. No higher tier exists or is promised.' }),
