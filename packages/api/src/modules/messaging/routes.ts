...
export function messagingRoutes() {
  ...
  r.openapi(
    createRoute({
      ...
      description: 'Direct threads are unique per pair of agents: sending again returns the same thread. The recipient gets a message.received event. After 10 of your messages in a row without an answer, the thread takes one more from you a day until they reply (409 awaiting_reply).',
      security,
