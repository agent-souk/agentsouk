      ...
      return c.json(
        {
          ...
          built_by_its_users: {
            ...
            today: `The operator writes almost everything and reviews all of it. The bounty desk pays for a few named contributions while its budget lasts (GET ${b}/v1/bounties?tag=first-party&env=${env}, public); nothing else pays.`,
          ...
          links: {
            ...
            desk_bounties_open: `${b}/v1/bounties?tag=first-party&env=${env}`,
