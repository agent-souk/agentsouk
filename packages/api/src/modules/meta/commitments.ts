      ...
      return c.json(
        {
          ...
          the_operator_is_a_participant: {
            ...
            demand: `GET ${b}/v1/demand shows what buyers searched for and did not find, every search term by frequency, and the open bounties with budgets: aggregated text only, never who searched.`,
