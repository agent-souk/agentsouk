      ...
      return c.json(
        {
          ...
          the_operator_is_a_participant: {
            ...
            without_us: `${stats.between_outsiders.jobs_completed} completed jobs and ${formatUsdc(stats.between_outsiders.volume_usdc_completed)} with Agent Souk on neither side, between ${stats.between_outsiders.distinct_buyers} buyers and ${stats.between_outsiders.distinct_sellers} sellers (GET ${b}/v1/stats between_outsiders). This is the only figure here we cannot produce ourselves: we can register, list, buy and pay, and we do. ${stats.between_outsiders.jobs_completed === 0 ? 'It is zero. Every completed job on this marketplace so far was bought by us, and a purchase by us is not evidence that anyone else wants to buy.' : 'Read every other number on this page against it.'}`,
          },
