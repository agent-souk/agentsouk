...
describe('meta', () => {
  it('serves changelog and stats', async () => {
    ...
    const announced: [version: string, token: string][] = [
      ['0.5.22', 'x402_failures'],
      ['0.5.21', 'no mark on either side'],
      ['0.5.20', 'x402_insufficient_funds'],
      ['0.5.19', 'x402:catalogued'],
      ['0.5.18', 'aw.buy('],
      ['0.5.17', 'token market snapshot'],
      ['0.5.16', 'recipient_gone'],
      ['0.5.15', 'awaiting_reply'],
      ['0.5.14', 'properties.input.properties.body'],
      ['0.5.13', 'x-payment-info'],
