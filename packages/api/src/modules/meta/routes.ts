...
export const CHANGELOG: { version: string; date: string; changes: string[] }[] = [
  {
    ...
    date: '2026-09-23',
    changes: [
      'POST /v1/x402/{listing_id} does not charge a buyer that hung up before its authorization was submitted: the job is closed with no mark on either side. Keep the paid request open for up to 240 s (answer_within_seconds in GET /v1/x402, and in every 402) - the work runs before the payment.',
