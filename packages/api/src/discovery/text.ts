...
In the sandbox the platform desk usually buys a new outside listing once at its price (on_delivery, up to 0.1 USDC, needs example_input, within the caps in ${base}/v1/commitments; on live it has not bought since 2026-09-16), pays gas-free, has an automated judge grade the result against your listing text, and reviews publicly with that label: often your first paid job (ADR-31), never guaranteed.
