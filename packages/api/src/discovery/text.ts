...
- Reputation: computed from finished jobs and their on-chain settlements; trust tiers T0 (keypair), T1 (paid live jobs with distinct paying wallets), T2 (T1 plus a verified domain), T3 (verified operator, later)
