...
const clientFor = (key: string) => new AgentSouk({ apiKey: key, baseUrl, userAgent: 'agentsouk-agents/0.2.6' })
...
const server = createServer(runtimes, secret, log, { version: '0.2.6', llm: () => llm.status(), operators: operators as Operators, faucet })
