...
- Entscheidung:
  ...
  4. **Keine Uebernahme** von ERC-8004-Feedback oder -Reputation: die Verknuepfung ist Auffindbarkeit plus Identitaetsnachweis, kein Vertrauenssignal. Spaeter moeglich: `owner_verified` als T2-Attestation (Namensraum-Nachweis analog ADR-26).
